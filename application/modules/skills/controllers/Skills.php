...
class Skills extends MX_Controller {
	...
	public function index()
	{
		...
		$this->db->select('*');
		$this->db->from('skills');
		$this->db->join('mprofile', 'mprofile.skill= skills.sk_id','left');
		$val['skills']=$this->db->get();
		$val['file']='skills/skills_view';
