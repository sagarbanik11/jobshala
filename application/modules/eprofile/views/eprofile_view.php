...
<div class="container align-middle" style="margin-top:95px;">
    <div class="card mb-3" id="mentor-card" style="max-width: 569px;">
        <?php foreach ($data->result() as $r) { ?>
            ...
            <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title" style="font-weight: 600;"><?= $_SESSION['name'] ?></h5>
                        <hr>
                        ...
                        <p class="card-text" style="font-weight: 500;font-size: 14px;">
                            <span id="bold-head">Sector: </span><?= $r->sector ?>
                        </p>
                        </p>
                        <p class="card-text" style="font-weight: 500;font-size: 14px;">
                            <span id="bold-head">Industry: </span><?= $r->industry ?>
                        </p>
                        <p class="card-text" style="font-weight: 500;font-size: 14px;">
                            <span id="bold-head">Address: </span><?= $r->address ?>
                        </p>
                        <p class="card-text" style="font-weight: 500;font-size: 14px;">
                            <span id="bold-head">About Company: </span><?= $r->about ?>
                        </p>
                        </p>
                        <p class="card-text" style="font-weight: 500;font-size: 14px;">
