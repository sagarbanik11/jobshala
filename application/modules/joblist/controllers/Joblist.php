...
class Joblist extends MX_Controller {
	function __construct() {
		
		$this->load->model('mdl_joblist');
	...
	public function single()
	{
		...
		$this->db->select('*');
		$this->db->from('joblist');
		$this->db->join('eprofile', 'eprofile.u_id= joblist.u_id');
		$this->db->join('user', 'user.u_id= eprofile.u_id');
